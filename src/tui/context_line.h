...
namespace kepler {
    namespace tui {
        namespace {
            ...
            public:
                ...
                Element Render() override {
                    ...
                    std::string& content = input_content_();
            ...
            private:
                ...
                StringUTF8& offset_content_() {
                    return context_(offset_).currentLine;
                }
        ...
        Component ContextLine(kepler::Session* session) {
            return Make<ContextLineBase>(std::move(session));
        }
    };
};